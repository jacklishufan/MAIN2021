...
cfg.DATASETS.TRAIN = ("audiogram_axis_train",
                        #"audiogram_original"
)
cfg.DATASETS.TEST = ("audiogram_axis_test",)
...
cfg.OUTPUT_DIR = "models/axis_detector"

single_iteration = 1* cfg.SOLVER.IMS_PER_BATCH
iterations_for_one_epoch = int(202 / single_iteration)
